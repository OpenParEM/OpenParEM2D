...
void FieldPoint::save_field_component (ofstream *out, const char *casename, int *casenumber, const char *field_component, double mag, double phi, double theta, double xVal, double yVal)
{
   if (mag > fieldMagLimit) {
      ...
      *out << frequency << "," << mode+1 << ",0," << field_component << "mag," << x << "," << y << "," << "equal," << setprecision(15) << mag << "," << setprecision(15) << equalErrorLimit << endl;

      // phi
      if (sqrt(xVal*xVal+yVal*yVal) > fieldMagLimit) {
         if (fabs(phi) > fieldMagLimit) {
            *out << casename <<  "_" << frequency_unique_index+1 << "_" << mode+1 << "_" << (*casenumber)++ << "_field" << ",";
            *out << frequency << "," << mode+1 << ",0," << field_component << "phi," << x << "," << y << "," << "equal," << setprecision(15) << phi << "," << setprecision(15) << equalErrorLimit << endl;
         } else {
            *out << casename <<  "_" << frequency_unique_index+1 << "_" << mode+1 << "_" << (*casenumber)++ << "_field" << ",";
            *out << frequency << "," << mode+1 << ",0," << field_component << "phi," << x << "," << y << "," << "lessthan," << setprecision(15) << lessthanErrorLimit << endl;
         }
      }
      ...
      if (fabs(theta) > fieldMagLimit) {
         *out << casename <<  "_" << frequency_unique_index+1 << "_" << mode+1 << "_" << (*casenumber)++ << "_field" << ",";
         *out << frequency << "," << mode+1 << ",0," << field_component << "theta," << x << "," << y << "," << "equal," << setprecision(15) << theta << "," << setprecision(15) << equalErrorLimit << endl;
      } else {
         *out << casename <<  "_" << frequency_unique_index+1 << "_" << mode+1 << "_" << (*casenumber)++ << "_field" << ",";
         *out << frequency << "," << mode+1 << ",0," << field_component << "theta," << x << "," << y << "," << "lessthan," << setprecision(15) << lessthanErrorLimit << endl;
      }
      ...
      // mag
      *out << casename <<  "_" << frequency_unique_index+1 << "_" << mode+1 << "_" << (*casenumber)++ << "_field" << ",";
      *out << frequency << "," << mode+1 << ",0," << field_component << "mag," << x << "," << y << "," << "lessthan," << setprecision(15) << lessthanErrorLimit << endl;
